...
class NestedUNet(nn.Module):
    ...
    def __init__(self,  depth = 3, n_blocks=2, first_inputchannels=32, activation=0, dropout=0.05):
        ...
        self.contraction = Contraction_Path(depth = depth, n_blocks=n_blocks, first_inputchannels=first_inputchannels, activation=activation, dropout=dropout)
        self.expansion = Expansion_Path(depth = depth, n_blocks=n_blocks, first_inputchannels=first_inputchannels, activation=activation, dropout=dropout)
