...
class MagnificationNet(nn.Module):
    def __init__(self,
        ...
        self.dense1 = nn.Linear(first_inputchannels * down_sampling * down_sampling * int(patch * 2 / 8) ** 2,
                                # the * 2 is the FFT padding factor 2.
                                int(math.sqrt(first_inputchannels)) * patch * down_sampling * 2)
        self.dense2 = nn.Linear(int(math.sqrt(first_inputchannels)) * patch * down_sampling * 2,
